...
echo -e "  ${GREEN}✓${NC} ${CYAN}.agents/rules/${NC} (Strict Governance: agency-design, document-governance, engineering-architecture)"
echo -e "  ${GREEN}✓${NC} ${CYAN}.agents/skills/${NC} (11 Skill Agensi + Anti-Slop Suite + Terminal Guide)"
echo -e "  ${GREEN}✓${NC} ${CYAN}.agents/workflows/${NC} (lead-ideate-pipeline.md)"
echo -e "  ${GREEN}✓${NC} ${CYAN}AGENTS.md${NC} (Instruksi operasional global agen AI)"
echo -e "  ${GREEN}✓${NC} ${CYAN}docs/${NC} (Direktori luaran strategi dan spesifikasi teknikal design.md)"
echo ""
echo -e "${BOLD}Langkah Selanjutnya:${NC}"
echo -e "  ${YELLOW}0.${NC} Cek panduan alur & status:        ${BOLD}/skillpack-guide${NC} (atau: ${CYAN}bash .agents/skills/skillpack-guide/scripts/status.sh${NC})"
echo -e "  ${YELLOW}1.${NC} Jalankan orkestrasi ideasi bisnis: ${BOLD}/collect-lead-master-data${NC}"
echo -e "  ${YELLOW}2.${NC} Kalibrasi screenshot UI (jika ada): ${BOLD}/harmonize-design-reference${NC}"
echo -e "  ${YELLOW}3.${NC} Hasilkan spesifikasi teknikal:    ${BOLD}/generate-design-system${NC} (output: docs/design.md)"
echo -e "  ${YELLOW}4.${NC} Eksekusi koding instan + Visual QA: ${BOLD}/direct-build${NC}"
echo ""
